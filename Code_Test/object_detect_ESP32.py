...
# ESP32-CAM Stream URL (Change to your IP)
ESP32_STREAM_URL = "http://172.20.10.11:81/stream"

# MQTT Configuration    
MQTT_BROKER = "broker.emqx.io"   # Change this to your broker IP if needed
MQTT_PORT = 1883
...
if not cap.isOpened():
    print(f"Error: Could not open ESP32 stream at {ESP32_STREAM_URL}")
    exit()
...
while True:
    ...
    cv2.imshow("YOLOv8 - MQTT Detection (ESP32-CAM)", annotated_frame)
